...
[button x=120 y=260 width=400 graphic="title/button_hajimeru.png" enterimg="title/hajimeruK.png" hint="ゲームを始めます" enterse="cursor2.ogg" clickse="decision7.ogg" target="gamestart"]
;スタートボタンの配置。これを押すとgamestartに飛ぶ。
;enterimg--カーソルを乗せたときに表示する画像
;hint--カーソルを乗せたときの説明
;enterse--カーソルを乗せたときの効果音
;ckicse--選択したときの効果音
[button x=120 y=360 width=400 graphic="title/button_tudukikara.png" enterimg="title/tudukikaraK.png" hint="続きから出来ます" enterse="cursor2.ogg" clickse="decision7.ogg" role="load" ]
